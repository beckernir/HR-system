...
// interface ProfilePageProps {
//   userId?: string; // Optional: if provided, fetch specific user; otherwise fetch current user
//   apiService: {
//     getCurrentUser: () => Promise<any>;
//     getUserProfile: (userId: string) => Promise<any>;
//   };
...
//               {/* Social links */}
//               <div className="flex gap-2 mt-4">
//                 <a href="#" className="p-2 bg-gray-100 text-blue-800 rounded-md hover:bg-gray-200 transition-colors">
//                   <FaLinkedin size={16} />
//                 </a>
//                 <a href="#" className="p-2 bg-gray-100 text-blue-800 rounded-md hover:bg-gray-200 transition-colors">
//                   <FaInstagram size={16} />
...
//             {workExperience.length > 0 && (
//               <div className="mt-8">
//                 <h3 className="text-lg font-semibold mb-4">Working Background</h3>
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                   {workExperience.map((work, index) => (
...
//                       />
//                       <div className="flex-1">
//                         <p className="font-semibold">{work.company} ({work.year})</p>
//                         <p className="text-sm text-gray-600">Position: {work.position}</p>
//                         <p className="text-sm text-gray-500">Experience: {work.experience}</p>
//                       </div>
//                     </div>
//                   ))}
//                 </div>
...
// // Main Container Component
// const ProfilePageContainer: React.FC<ProfilePageProps> = ({ userId, apiService }) => {
//   console.log("User ID:", userId);

//   // const router = useRouter();
//   // const { userId } = router.query; // Get userId from URL parameters
