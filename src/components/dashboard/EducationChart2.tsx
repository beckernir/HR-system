...
export default function EducationChart({ selectedYear }: EducationChartProps) {
  const data = [
    { name: "B.S / B.A Degree", value: 32, color: "#65B741", year: 2025 },
    { name: "Master Degree", value: 25, color: "#3A86FF", year: 2024 },
    { name: "Ph.D / P.E Degree", value: 24, color: "#FF9E00", year: 2023 },
    { name: "Masters / MBA", value: 46, color: "#FF5678", year: 2022 }
  ];
  ...
  return (
    <Card className="bg-[#E0E2E5] backdrop-blur-sm border-0">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 gap-2 -mt-[9rem] mr-3 float-right">
          {data.map((item) => (
